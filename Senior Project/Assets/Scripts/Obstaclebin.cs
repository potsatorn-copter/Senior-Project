...
public class Obstaclebin : MonoBehaviour
{
    ...
    // ฟังก์ชันนี้จะถูกเรียกเมื่อมีการชนกับวัตถุอื่น
    private void OnTriggerEnter2D(Collider other)
    {
        if (other.CompareTag("Bottle")) // ตรวจสอบว่าชนกับขวดหรือไม่
        {
            Destroy(other.gameObject); // ทำลายขวดเมื่อชนกับมอนสเตอร์
            Debug.Log("Bottle destroyed by monster.");
        }
    }
